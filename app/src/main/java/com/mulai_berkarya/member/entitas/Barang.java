...
public class Barang {
    private String id_barang, nama_barang, harga_barang, berat, stok, deskripsi, gambar, rate;
    ...
    public Barang(String id_barang, String nama_barang, String harga_barang, String berat, String stok, String deskripsi, String terjual, String rate) {
