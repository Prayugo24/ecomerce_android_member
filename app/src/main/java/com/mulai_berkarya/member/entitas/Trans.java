...
public class Trans {
    ...
    public String getKonf_bay() { return konf_bay; }
    public String getNo_resi() { return no_resi; }
    ...
    public void setKonf_bay(String konf_bay) { this.konf_bay= konf_bay; }
    public void setNo_resi(String no_resi) { this.no_resi= no_resi; }
}
